<section id="two_kit">
	...
	<div class="container">
		<div class="row">
			<h2 class="sale_ttl">Спеціальна пропозиція</h2>
			<div class="col-md-6 sale_info col-xs-12">
				<div class="timer_block">
					...
					<div class="buy_btn" data-toggle="modal" data-target="#exampleModal" data-whatever="{title}"
						data-price="[xfvalue_new_price]" data-olx-link="[xfvalue_olx_linck]">ЗАМОВИТИ</div>
				</div>
			</div>
			<div class="col-md-6 col-xs-12 sale_timer">
				...
				<div id="clockdiv">
					<h3 class="timer_ttl">До кінця акції залишилось</h3>
