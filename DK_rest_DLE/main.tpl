...
<div class="col-md-6 col-xs-12">
	...
	<main>
		...
		<div id="goods_items" class="container produkt_items">
			...
			<div class="row">
				<div class="col-md-12 col-xs-12 main_top_seo">
<p>Гарне освітлення дорожнього полотна – важливий фактор вашої безпеки, особливо в темну пору доби і дощову погоду. Рано чи пізно кожен власник автомобіля стикається з проблемою помутніння фар і втратою їх прозорості. Придбавши наш набір для відновлення прозорості та захисту фар Delta kits Ви не тільки повернете їм заводський блиск але і покращите видимість в темну пору доби.</p>

 
	<h3>Головні переваги покриття фар лаком Delta kits:</h3>
	<ul>
		<li><strong>Стійкість. </strong> Лак для відновлення фар Delta kits підвищує стійкість пластика до ударів каміння та піску, а також до агресивного впливу навколишнього середовища.</li>
		<li><strong>Безпека.</strong> Відновлення фар лаком Delta kits забезпечить хорошу видимість, яка особливо актуальна в темну пору доби, дощову та туманну погоду. Після відновлення фар ризик потрапити в ями або відкриті люки значно зменшиться.</li>
		<li><strong>Довговічність.</strong> Лак для відновлення фар швидко висихає і довго не втрачає властивості. В середньому термін експлуатації покриття Infinity 4.1 два-три роки, Coat2Protect півтора-два.</li>
		<li><strong>Економія.</strong> Відновлення прозорості та захисту фар лаком Delta kits обійдеться значно дешевше ніж заміна фар на нові. А завдяки довговічності покриття, Вам не знадобиться часто його поновлювати.</li>
		<li><strong>Екологічність.</strong> Лак компанії Delta kits не має токсичного впливу на людську шкіру чи органи дихання і не шкодить навколишньому середовищу.</li>
		<li><strong>Відмінний вигляд.</strong> Відновлення фар поверне вашому автомобілю привабливий вигляд</li>
	</ul>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4 youtube_item">
				<iframe width="100%" height="300" src="https://www.youtube.com/embed/5yFqFU9EOok" frameborder="0" allowfullscreen></iframe>
				
					<span>Как наносить лак Delta Kits</span>
				</div>
				<div class="col-md-4 youtube_item">
					<iframe width="100%" height="300" src="https://www.youtube.com/embed/h-0DpQwumUg" frameborder="0" allowfullscreen></iframe>
					
						<span>Восстановления фар Volkswagen Passat B5 с помощью лака Delta Kits Infinity</span>
					</div>
					<div class="col-md-4 youtube_item">
						<iframe width="100%" height="300" src="https://www.youtube.com/embed/dgKF1_tXKMo" frameborder="0" allowfullscreen></iframe>
...
<section id="about_work">
	...
	<div class=" about_work">
			...
			<div class="car wow fadeInLeft" data-wow-duration="1.7s" data-wow-delay="1s" style="opacity: 1;"></div>
...
<section id="testimonals">
		...
		<center><div class="fb-comments" data-href="http://dk-restore.com.ua" data-width="700" data-numposts="5"></div></center>
...
<!-- END Hidden Required Fields -->
			  ...
			  <div class="form-group">
				...
				<input name="ім'я" type="text" class="form-control" id="recipient-name" placeholder="Ваше ім'я" required>
			  </div>
			  <div class="form-group">
				
					<input name="Прізвище" type="text" class="form-control" id="recipient-altname" placeholder="Ваше прізвище" required>
				  </div>
			  <div class="form-group">
